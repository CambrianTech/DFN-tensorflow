...
class DFN(object):
	...
	def _summary(self):
		...
		trainval_summary.append(tf.summary.image("input_image", self.X[:, :, :, :3], max_outputs=3))
		trainval_summary.append(tf.summary.image("input_normals", self.X[:, :, :, 3:], max_outputs=3))
		trainval_summary.append(tf.summary.image("output", self.Y[:, :, :, :3], max_outputs=3))
		trainval_summary.append(tf.summary.image("prediction", self.softmax_fuse[:, :, :, :3], max_outputs=3))
