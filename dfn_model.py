...
class DFN(object):
	...
	def _summary(self):
		...
		trainval_summary.append(tf.summary.image("input_mask", tf.cast(255 * self.X[:, :, :, 3:4], tf.uint8), max_outputs=3))
		trainval_summary.append(tf.summary.image("input_edges", tf.cast(255 * self.X[:, :, :, 4:5], tf.uint8), max_outputs=3))
